...
<div class="footer"><p style="margin:0 0 10px 0">Trusticket está en fase beta. Si algo no funciona como esperabas, escríbenos a <a href="mailto:trusticketinfo@gmail.com" style="color:inherit">trusticketinfo@gmail.com</a></p><p>© 2025 Trusticket — Opinión recibida desde la plataforma.</p></div>
</div></body></html>`;
}
