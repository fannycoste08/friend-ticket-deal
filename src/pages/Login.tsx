  ...
  return (
    <div className="min-h-screen bg-black">
      ...
      <div className="flex flex-col lg:flex-row">
        ...
        {/* Login Form Section */}
        <div className="flex-1 flex items-center justify-center p-4 lg:p-8 bg-gradient-to-b from-zinc-950 to-zinc-900 lg:min-h-screen">
          <Card className="w-full max-w-md bg-zinc-900/50 border-zinc-800 backdrop-blur-sm" style={{ boxShadow: "0 0 50px rgba(0,0,0,0.5)" }}>
      ...
      {/* Bottom Section: What is Trusticket - Full Width */}
      <div className="w-full bg-gradient-to-b from-zinc-900 to-black py-16 px-4 lg:px-8">
        <div className="max-w-6xl mx-auto">
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-lg p-8 lg:p-12 backdrop-blur-sm">
            <div className="text-center mb-10">
              <h2 className="text-3xl lg:text-4xl font-bold text-white mb-3">¿Qué es Trusticket?</h2>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="flex flex-col items-center text-center">
                <div className="w-16 h-16 rounded-lg bg-purple-900/30 flex items-center justify-center mb-4">
