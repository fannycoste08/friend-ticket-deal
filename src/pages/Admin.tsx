                ...
                <table className="w-full">
                  <thead className="bg-muted/50">
                    <tr>
                      ...
                      <th
                        className="text-left px-2 py-2 font-medium text-xs cursor-pointer select-none hover:text-foreground transition-colors"
                      ...
                      <th
                        className="text-center px-2 py-2 font-medium text-xs cursor-pointer select-none hover:text-foreground transition-colors"
                      ...
                      >
                        <span className="inline-flex items-center gap-1">Acceso <SortIcon column="last_sign_in_at" /></span>
                      </th>
                            ...
                            >
                              ...
                              <td className="px-2 py-2">
                                <div className="flex items-center gap-2 min-w-0">
                                  ...
                                  <span className="font-medium text-xs truncate max-w-[140px]" title={user.name}>{user.name}</span>
                                </div>
                              </td>
                              <td className="px-2 py-2 text-muted-foreground text-xs">
                                <span className="block truncate max-w-[190px]" title={user.email}>{user.email}</span>
                              </td>
                              ...
                              <td className="px-2 py-2 text-xs">
                                {user.last_sign_in_at ? (
                                  ...
                                  <span className="font-medium text-orange-500">Nunca</span>
                                ) : (
                                  <span className="text-destructive font-medium">Sin contr.</span>
                                )}
                              </td>
                              <td className="px-2 py-2" onClick={(e) => e.stopPropagation()}>
                                <div className="flex items-center justify-center gap-1">
                                  {user.newsletter_unsubscribed ? (
                                    <span className="inline-flex items-center gap-0.5 text-[11px] text-muted-foreground" title="Dado de baja">
                                      <Ban className="w-3 h-3" />
                                      Baja
                                    </span>
                                  ) : canEmail(user) ? (
                                    <span className="inline-flex items-center gap-0.5 text-[11px] font-medium text-emerald-500" title="Puede recibir emails">
                                      <MailCheck className="w-3 h-3" />
                                      Sí
                                    </span>
                                  ) : (
                                    <span className="inline-flex items-center gap-0.5 text-[11px] font-medium text-destructive" title="No ha iniciado sesión nunca">
                              ...
                              <td className="px-2 py-2 text-center text-xs">
                                {user.invite_origin === 'B' ? (
                                  <Badge variant="outline" className="border-purple-500/40 text-purple-400 px-1.5 py-0 text-[11px]" title="Invitado directamente por otro usuario">
                                    B
                                  </Badge>
                                ) : user.invite_origin === 'A2' ? (
                                  <Badge variant="outline" className="border-blue-500/40 text-blue-400 px-1.5 py-0 text-[11px]" title="Pidió acceso él mismo y fue aprobado después">
                                    A2
                                  </Badge>
