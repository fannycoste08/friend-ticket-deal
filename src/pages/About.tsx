      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <article className="fade-in-up">
          ...
          <div className="space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>Llevo más de 10 años con un <a href="https://docs.google.com/spreadsheets/d/1bCX2DCK8dBlxhxWHG6ST7QxaYp5kHjj_qoNwE_rTh8g/edit?gid=1912233662#gid=1912233662" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2 hover:opacity-80 transition-opacity">Excel</a> donde apunto conciertos a los que quiero ir (sí, un <a href="https://docs.google.com/spreadsheets/d/1bCX2DCK8dBlxhxWHG6ST7QxaYp5kHjj_qoNwE_rTh8g/edit?gid=1912233662#gid=1912233662" target="_blank" rel="noopener noreferrer" className="text-primary underline underline-offset-2 hover:opacity-80 transition-opacity">Excel</a>) y hago playlists mensuales en Spotify para no perderme nada de lo que voy descubriendo por el camino.</p>
